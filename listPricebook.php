                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url();?>pricebook/viewPricebookList/<?php echo $this->common_model->encode($PB->id);?>" >
                                                     <i class="ri-eye-fill icons view" title="View"> </i></a><?php } ?>
                                                     
                                                      <i class="ri-edit-2-fill icons edit mx-2" title="Edit"></i> <i
                                                        class="ri-delete-bin-fill icons delete" title="Delete"></i> 
                                                </td>
                                            </tr>
                                        <?php } } ?>
